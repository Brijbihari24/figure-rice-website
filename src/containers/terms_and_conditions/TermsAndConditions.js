            ...
            <section className="page-banner text-white py-165 rpy-130" style={{ backgroundImage: 'url(/assets/images/banner_image.jpg)' }}>
                <div className="container">
                    <div className="banner-inner text-center">
                        <span className="bg-text">Terms & Conditions</span>
                        <h1 className="page-title wow fadeInUp delay-0-2s">Terms & Conditions</h1>
                        {
            ...
            <section className="section-padding">
                <div className="container">
                    <div className="row g-4">
                        <div className="col-12 col-xl-12 privacy-content">
                            <h3 className="fw-bold privacy-heading">Terms & Conditions</h3>
                            <hr />
                            {
                                // dynamic terms & cond. content 
                            }
                            ...
                            <ul>
                                ...
                                <li>
                                    <p><strong>Company</strong> (referred to as either &quot;the Company&quot;, &quot;We&quot;, &quot;Us&quot; or &quot;Our&quot; in this Agreement) refers to Rejuve Aesthetics.</p>
                                </li>
                                <li>
                                ...
                                <li>
                                    <p><strong>Website</strong> refers to Rejuve Aesthetics, accessible from <a href="https://rejuve.luhaifdigitech.com/" rel="external nofollow noopener" target="_blank">https://rejuve.luhaifdigitech.com/</a></p>
                                </li>
                                <li>
                            ...
                            <ul>
                                <li>
                                    <p>By email: Rejuveaestheticlinic@gmail.com</p>
                                </li>
                                <li>
                                    <p>By phone number: 80116 11002</p>
                                </li>
                            </ul>
                        </div>
                    </div>
